...
import {
  ArrowUpRight, GithubLogo, LinkedinLogo, Envelope, CaretDown
      ...
      <main style={{
        ...
        <header style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", paddingLeft: "clamp(3rem, 8vw, 9rem)", zIndex: 20, pointerEvents: "none", userSelect: "none", mixBlendMode: "normal" }}>
          <div>
            ...
            <div className="hero-line" style={{ opacity: 0, marginTop: "2.2rem", display: "flex", gap: "1.25rem", pointerEvents: "auto", alignItems: "center" }}>
              <a href="mailto:omkaarshenoyos@gmail.com"
        ...
        <LogoScrap src="/images/aramark-logo.png" alt="Aramark"
        ...
        <LogoScrap src="/images/npr-logo.png" alt="NPR"
        ...
        <LogoScrap src="/images/webstaurantstore-logo.png" alt="WebstaurantStore"
        ...
        <LogoScrap src="/images/asu-logo.png" alt="Arizona State University"
        ...
        <LogoScrap src="/images/sunhacks-logo.png" alt="sunhacks"
        ...
        <LogoScrap src="/images/snowflake-logo.png" alt="Snowflake"
        ...
        <LogoScrap src="/images/dbt-logo.png" alt="dbt"
        ...
        <LogoScrap src="/images/azure-logo.png" alt="Microsoft Azure"
        ...
        <LogoScrap src="/images/java-logo.png" alt="Java"
        ...
        <LogoScrap src="/images/python-logo.png" alt="Python"
        ...
        <LogoScrap src="/images/docker-logo.png" alt="Docker"
        ...
        <LogoScrap src="/images/mongodb-logo.png" alt="MongoDB"
        ...
        <LogoScrap src="/images/kubernetes-logo.png" alt="Kubernetes"
        ...
        <LogoScrap src="/images/postgresql-logo.png" alt="PostgreSQL"
        ...
        <nav style={{ position: "fixed", top: "2rem", right: "2rem", zIndex: 1000, display: "flex", flexDirection: "row", gap: "1.5rem", pointerEvents: "auto" }} aria-label="Theme toggle">
          ...
          >
            ...
            <img src="/images/lamp.png" alt="Light Mode" style={{ position: "relative", zIndex: 1, width: "75px", height: "75px", objectFit: "contain", filter: isLightMode ? "drop-shadow(2px 4px 6px rgba(0,0,0,0.3))" : "drop-shadow(0 0 10px rgba(255,250,210,0.3))" }} />
          </button>
        </nav>
